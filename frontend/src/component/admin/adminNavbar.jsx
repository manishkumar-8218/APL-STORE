    ...
    return (
        <div className=" w-screen flex  flex-row bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  h-16 shadow-lg shadow-cyan-500/50 bg-fixed">
            ...
            <div className="w-2/3 flex justify-end  items-center">
                ...
                <div className=" mx-8">
                    <Link className="text-xl text-black font-semibold hover:text-red-700" to="/makeLibrerieInfo">Info</Link>
                </div>
                <div className=" mr-16">
                    <Link className="text-xl text-black font-semibold hover:text-red-700" to="/makeLibrerieCard">Librerie</Link>
                </div>
            </div>
        </div>
    );
